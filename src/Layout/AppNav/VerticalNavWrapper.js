...
import {MainNav, ComponentsNav, FormsNav, WidgetsNav, ChartsNav, JobPortalNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <MetisMenu content={JobPortalNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
